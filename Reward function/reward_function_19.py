...
def get_target_point(params):
    mod_waypoints = [params['waypoints'][i] for i in range(0, len(params['waypoints']), 7)]
    mod_up_waypoints = up_sample(get_waypoints_ordered_in_driving_direction(params, mod_waypoints), 3)
    mod_up_waypoints[-1] = mod_up_waypoints[0]
    waypoints = mod_up_waypoints
...
def score_steer_to_point_ahead(params):
    ...
    return reward  # optimizer is rumored to struggle with negative numbers and numbers too close to zero
